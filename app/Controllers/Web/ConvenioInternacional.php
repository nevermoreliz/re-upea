...
class ConvenioInternacional extends BaseController
{
    ...
    public function list()
    {
        ...
        $lib = new TableLibNormalWhere('re_vista_convenio_internacional', $column_map, $arrayWhere);
    ...
    public function show($id)
    {
        ...
        $registro = $model->getFindVistaConvenioInternacionalActive($id);
        ...
        $data = [
            'convenioInternacional' => $registro
        ];

        return $this->templater->viewWeb('web/convenios/internacional/showSingle', $data);
    }
