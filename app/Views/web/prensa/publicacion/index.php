                ...
                <div class="row">
                    <div class="col-lg-5">
                        ...
                        <div class="list-tags-job">
                            <a href="#" class="text-normal job-tag">UI/UX designing <span
            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-12 float-right">
                <div class="content-page">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn"
                                ...
                                <div class="text-center card-grid-2-image">
                                    <a href="job-single.html">
                                        <figure><img alt="jobhub"
                                                     src="<?= base_url('web/') ?>assets/imgs/jobs/job-2.png"/></figure>
                                    </a>
                                    <label class="btn-urgent">Urgent</label>
                                </div>
                                <div class="card-block-info">
                                    <div class="row">
                                        <div class="col-lg-7 col-6">
                                            <a href="employers-single.html" class="card-2-img-text">
                                                <span class="card-grid-2-img-small"><img alt="jobhub"
                                                                                         src="<?= base_url('web/') ?>assets/imgs/jobs/logos/logo-2.svg"/></span>
                                                <span>Amanda</span>
                                            </a>
                                        </div>
                                        <div class="col-lg-5 col-6 text-end">
                                    ...
                                    <h5 class="mt-20"><a href="job-single.html">A professional Facebook cover photo
                                            banner design</a></h5>
                                    <div class="mt-15">
                                        <span class="card-time">3 mins ago</span>
                                        <span class="card-location">Wisconsin</span>
                                    </div>
                                    <div class="card-2-bottom mt-30">
                                        <div class="row">
                                            <div class="col-lg-7 col-8">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".s">
                                <div class="text-center card-grid-2-image">
                                    <a href="job-single.html">
                                        <figure><img alt="jobhub"
                                                     src="<?= base_url('web/') ?>assets/imgs/jobs/job-3.png"/></figure>
                                    </a>
                                    <label class="btn-urgent">Urgent</label>
                                </div>
                                <div class="card-block-info">
                                    <div class="row">
                                        <div class="col-lg-7 col-6">
                                            <a href="employers-single.html" class="card-2-img-text">
                                                <span class="card-grid-2-img-small"><img alt="jobhub"
                                                                                         src="<?= base_url('web/') ?>assets/imgs/jobs/logos/logo-3.svg"/></span>
                                                <span>Reliabilt</span>
                                            </a>
                                        </div>
                                        <div class="col-lg-5 col-6 text-end">
                                    ...
                                    <h5 class="mt-20"><a href="job-single.html">Unique and aesthetic Instagram post
                                            images</a></h5>
                                    <div class="mt-15">
                                        <span class="card-time">3 mins ago</span>
                                        <span class="card-location">Virginia</span>
                                    </div>
                                    <div class="card-2-bottom mt-30">
                                        <div class="row">
                                            <div class="col-lg-7 col-8">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn"
                                ...
                                <div class="text-center card-grid-2-image">
                                    <a href="job-single.html">
                                        <figure><img alt="jobhub"
                                                     src="<?= base_url('web/') ?>assets/imgs/jobs/job-4.png"/></figure>
                                    </a>
                                    <label class="btn-urgent">Urgent</label>
                                </div>
                                <div class="card-block-info">
                                    <div class="row">
                                        <div class="col-lg-7 col-6">
                                            <a href="#" class="card-2-img-text">
                                                <span class="card-grid-2-img-small"><img alt="jobhub"
                                                                                         src="<?= base_url('web/') ?>assets/imgs/jobs/logos/logo-4.svg"/></span>
                                                <span>Maytag</span>
                                            </a>
                                        </div>
                                        <div class="col-lg-5 col-6 text-end">
                                    ...
                                    <h5 class="mt-20"><a href="job-single.html">Premium quality Instagram post and
                                            stories</a></h5>
                                    <div class="mt-15">
                                        <span class="card-time">3 mins ago</span>
                                        <span class="card-location">Florida</span>
                                    </div>
                                    <div class="card-2-bottom mt-30">
                                        <div class="row">
                                            <div class="col-lg-7 col-8">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".s">
                                <div class="text-center card-grid-2-image">
                                    <a href="job-single.html">
                                        <figure><img alt="jobhub"
                                                     src="<?= base_url('web/') ?>assets/imgs/jobs/job-5.png"/></figure>
                                    </a>
                                    <label class="btn-urgent">Urgent</label>
                                </div>
                                <div class="card-block-info">
                                    <div class="row">
                                        <div class="col-lg-7 col-6">
                                            <a href="#" class="card-2-img-text">
                                                <span class="card-grid-2-img-small"><img alt="jobhub"
                                                                                         src="<?= base_url('web/') ?>assets/imgs/jobs/logos/logo-5.svg"/></span>
                                                <span>Whirlpool</span>
                                            </a>
                                        </div>
                                        <div class="col-lg-5 col-6 text-end">
                                    ...
                                    <h5 class="mt-20"><a href="job-single.html">An amazing facebook banner, cover
                                            design</a></h5>
                                    <div class="mt-15">
                                        <span class="card-time">3 mins ago</span>
                                        <span class="card-location">Alaska</span>
                                    </div>
                                    <div class="card-2-bottom mt-30">
                                        <div class="row">
                                            <div class="col-lg-7 col-8">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn"
                                ...
                                <div class="text-center card-grid-2-image">
                                    <a href="job-single.html">
                                        <figure><img alt="jobhub"
                                                     src="<?= base_url('web/') ?>assets/imgs/jobs/job-6.png"/></figure>
                                    </a>
                                    <label class="btn-urgent">Urgent</label>
                                </div>
                                <div class="card-block-info">
                                    <div class="row">
                                        <div class="col-lg-7 col-6">
                                            <a href="#" class="card-2-img-text">
                                                <span class="card-grid-2-img-small"><img alt="jobhub"
                                                                                         src="<?= base_url('web/') ?>assets/imgs/jobs/logos/logo-6.svg"/></span>
                                                <span>Rigid</span>
                                            </a>
                                        </div>
                                        <div class="col-lg-5 col-6 text-end">
                                    ...
                                    <h5 class="mt-20"><a href="job-single.html">A complete social media pages setup</a>
                                    </h5>
                                    <div class="mt-15">
                                        <span class="card-time">3 mins ago</span>
                                        <span class="card-location">Colorado</span>
                                    </div>
                                    <div class="card-2-bottom mt-30">
                                        <div class="row">
                                            <div class="col-lg-7 col-8">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn" data-wow-delay=".s">
                                ...
                                <div class="card-block-info">
                                    ...
                                    <h5 class="mt-20"><a href="job-single.html">Senior Full Stack Engineer Full Time</a>
                                    </h5>
                                    <div class="mt-15">
                                        <span class="card-time">3 mins ago</span>
                                        <span class="card-location">New York</span>
                                    </div>
                                    <div class="card-2-bottom mt-30">
                                        <div class="row">
                                            <div class="col-lg-7 col-8">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn"
                                ...
                                <div class="card-block-info">
                                    ...
                                    <div class="mt-15">
                                        <span class="card-time">3 mins ago</span>
                                        <span class="card-location">Nebraska</span>
                                    </div>
                                    <div class="card-2-bottom mt-30">
                                        <div class="row">
                                            <div class="col-lg-7 col-8">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn"
                                ...
                                <div class="card-block-info">
                                    ...
                                    <div class="mt-15">
                                        <span class="card-time">3 mins ago</span>
                                        <span class="card-location">Indiana</span>
                                    </div>
                                    <div class="card-2-bottom mt-30">
                                        <div class="row">
                                            <div class="col-lg-7 col-8">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn"
                                ...
                                <div class="card-block-info">
                                    ...
                                    <div class="mt-15">
                                        <span class="card-time">3 mins ago</span>
                                        <span class="card-location">Idaho</span>
                                    </div>
                                    <div class="card-2-bottom mt-30">
                                        <div class="row">
                                            <div class="col-lg-7 col-8">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn"
                                ...
                                <div class="card-block-info">
                                    ...
                                    <div class="mt-15">
                                        <span class="card-time">3 mins ago</span>
                                        <span class="card-location">California</span>
                                    </div>
                                    <div class="card-2-bottom mt-30">
                                        <div class="row">
                                            <div class="col-lg-7 col-8">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="card-grid-2 hover-up wow animate__animated animate__fadeIn"
                                ...
                                <div class="card-block-info">
                                    ...
                                    <div class="mt-15">
                                        <span class="card-time">3 mins ago</span>
                                        <span class="card-location">Washington</span>
                                    </div>
                                    <div class="card-2-bottom mt-30">
                                        <div class="row">
                                            <div class="col-lg-7 col-8">
